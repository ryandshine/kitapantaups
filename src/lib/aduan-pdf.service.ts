...
export const AduanPdfService = {
    exportDetail: (aduan: Aduan, lokasiObjekItems: LokasiObjekItem[], tindakLanjutList: TindakLanjut[]) => {
        ...
        autoTable(doc, {
            ...
            head: [['Balai', 'Nama Lembaga', 'No. SK', 'Skema', 'Provinsi', 'Kabupaten', 'Luas (Ha)', 'KK', 'Status Kelas', 'Status RKPS']],
            ...
            headStyles: { fillColor: [...COLOR_BRAND] as any, textColor: [255, 255, 255], fontStyle: 'bold', fontSize: 6.5, valign: 'middle' },
            alternateRowStyles: { fillColor: [245, 243, 238] },
            theme: 'grid',
            tableWidth: 182,
            margin: { left: 14, right: 14, bottom: 14 },
