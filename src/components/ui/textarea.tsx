  ...
  ({ className, label, helperText, error, fullWidth, ...props }, ref) => {
    return (
      <div className={cn("flex flex-col gap-1.5", fullWidth ? "w-full" : "w-auto")}>
        ...
        <textarea
          className={cn(
            "flex min-h-[88px] w-full rounded-lg border border-border/80 bg-background/88 px-3 py-2.5 text-[0.92rem] text-foreground transition-all duration-200 placeholder:text-muted-foreground/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/20 focus-visible:border-primary/60 hover:border-border disabled:cursor-not-allowed disabled:opacity-50",
